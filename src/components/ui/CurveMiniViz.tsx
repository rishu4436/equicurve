/** Simple SVG bonding-curve shapes for Flat / Exp / Long presets. */
export function CurveMiniViz({
  preset,
  className = "",
}: {
  preset: "flat" | "exponential" | "long" | "equity";
  className?: string;
}) {
  ...
  return (
    ...
    >
      ...
      <path
        ...
        strokeLinecap="round"
      />
      <line x1="64" y1="4" x2="76" y2="4" stroke="#A78BFA" strokeWidth="2" strokeLinecap="round" />
      <defs>
