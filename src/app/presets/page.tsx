    ...
    <div className="space-y-8">
      <header>
        ...
        <p className="mt-2 max-w-2xl text-sm text-fg-secondary">
          Official Flat / Exponential / Long templates built with Meteora{" "}
          <code className="text-accent-soft">buildCurveWithMarketCap</code>.
          Community marketplace publishing is v1.1.
        </p>
      </header>
      ...
      {extra.map((p) => (
        <div key={p.id} className="ec-card flex flex-col gap-4 p-5 sm:flex-row sm:items-center sm:justify-between">
          <div>
